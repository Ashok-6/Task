...
public class ProjectServiceImp implements ProjectService {
	...
	{
		ProjectEntity projectentity = projectRepository.findById(projectId).orElseThrow(() -> new ProjectIdNotFoundException("Id Not Found"));
	...
	public List<ApiResponseDTO> getAllProjectTasks(Long projectId) {
		...
		List<TaskDTO> tasklist = taskClient.getAllTasksByPid(projectId);
